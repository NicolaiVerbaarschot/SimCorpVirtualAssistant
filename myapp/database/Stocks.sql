...
INSERT INTO DB_Data VALUES
    ('SUQJ','Bond',3903,'DKK',146,569838,'2038-05-04',21058,13718,4470),
    ('IIUZ','Bond',920,'DKK',469,431480,'2024-01-02',34739,14062,26288),
    ('GESZ','Fund',2020,'CAD',545,1100900,'2026-01-25',71822,11597,29567),
    ('HJET','Stock',2259,'USD',741,1673919,'2023-10-31',10092,140473,158568),
    ('OPBA','Fund',3057,'DKK',861,2632077,'2029-06-01',24557,150000,237603),
    ('ETVD','Stock',1931,'CAD',392,756952,'2033-07-14',49208,33133,2),
    ('NHXS','Stock',4397,'DKK',339,1490583,'2028-06-08',129866,105397,47647),
    ('FRVD','Stock',3025,'CAD',254,768350,'2022-05-09',64344,6976,53054),
    ('WWYK','Bond',2597,'USD',261,677817,'2023-08-14',48237,12476,57787),
    ('DTTG','Fund',745,'DKK',700,521500,'2020-10-20',29312,40032,34726),
    ('MTFX','Bond',1076,'USD',605,650980,'2021-01-06',4957,30619,1641),
    ('KATS','Bond',4016,'CAD',574,2305184,'2031-10-09',54622,11674,178255),
    ('AXJO','Bond',4325,'USD',210,908250,'2020-08-12',80567,81840,228),
    ('PBGF','Stock',695,'DKK',899,624805,'2028-11-06',29131,42041,43992),
    ('VMUO','Stock',4058,'USD',176,714208,'2022-06-19',5097,65563,64962),
    ('FEUB','Stock',3579,'USD',609,2179611,'2038-09-06',56857,19475,116205),
    ('OZEY','Fund',2638,'EUR',974,2569412,'2020-02-09',173021,208551,155831),
    ('NEAC','Bond',501,'DKK',377,188877,'2037-03-04',5371,7595,62),
    ('OPHW','Bond',3832,'EUR',79,302728,'2027-02-25',17046,25609,9701),
    ('KWQK','Bond',3310,'DKK',220,728200,'2023-04-07',48013,10841,70704);
